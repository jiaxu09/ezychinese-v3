      ...
      <div className='grid h-full w-full grid-rows-2 rounded-lg'>
        <div className='h-full w-full bg-pastelblue'>
          <div className='flex flex-col items-center justify-center space-y-4 py-4 md:py-6 '>
            ...
            <div className=' line-clamp-3 w-[90%] text-center text-lg italic md:text-xl'>
              {eng_meaning}
            </div>
          </div>
        </div>
        <div className='flex h-full w-full flex-col items-center justify-center bg-skyblue px-2 pb-4'>
          ...
          <p className='text-center text-lg italic md:text-2xl md:leading-relaxed md:tracking-wider'>
            {example_meaning}
          </p>
        </div>
      </div>
