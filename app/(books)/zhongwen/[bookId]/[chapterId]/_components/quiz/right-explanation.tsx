...
const RightExplanation = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-6 pb-2 w-full ">
      ...
      <div className="flex items-center justify-start md:justify-center flex-wrap gap-4">
        {choices.map((ci, index) => (
          <div className="flex items-center" key={index}>
            {index === 0 && (
              <span className="mr-2 w-6 h-6 flex items-center justify-center rounded-full bg-crayola">
                A
              </span>
            )}
            {index === 1 && (
              <span className="mr-2 w-6 h-6 flex items-center justify-center rounded-full bg-skyblue">
                B
              </span>
            )}
            {index === 2 && (
            ...
            {index === 3 && (
              <span className="mr-2 w-6 h-6 flex items-center justify-center rounded-full bg-pewterblue">
                D
              </span>
            )}
